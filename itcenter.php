...
$today = date('l');
$query = "SELECT * FROM itcenter_schedule WHERE day_of_week = '$today'";
...
<head>
    <meta charset="UTF-8">
    <title>IT Center Schedule - University of Vavuniya</title>
    <style>
        body {
...
<body>
    ...
    <h1>University of Vavuniya - IT Center Schedule</h1>
    <h2><?php echo date("l, F j, Y"); ?></h2>

    <!-- Status Section -->
    <div class="status <?php echo $status; ?>">
        IT Center is <?php echo strtoupper($status); ?> Today
    </div>

    <!-- Conditionally show time only if status is Open -->
    ...
    <div class="download-section">
        ...
        <p>If you have any issues or suggestions regarding the IT Center, please leave your feedback anonymously:</p>
    ...
    <div class="download-section">
        <h2>---------- IT Center Registration Form ----------</h2>
        <p>If you'd like to register for IT Center services, please complete the form below:</p>
    ...
    <script>
        async function downloadPDF() {
            ...
            let content = `IT Center Registration Form\n\n`;
            content += `Name: ${name}\n`;
            ...
            doc.save("ITCenter_Registration.pdf");
        }
    </script>
